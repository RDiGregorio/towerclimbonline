...
class Ego {
  ...
  static const Map<int, String> longDescriptions = {
    ...
    fast: 'fast movement',
    slow: null,
    wrath: 'berserk attack (+900% damage)',
    ...
    sweep: null,
    all: 'area of effect',
    energy: 'energy attack (+200% damage)',
    ...
    parry: '25% parry',
    death: 'death attack (kills target)',
    metal: 'made of metal (upgraded with metalworking)',
